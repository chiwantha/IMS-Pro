...
namespace IMS_Upgraded_C_
{
    internal class Connection
    {
        public SqlConnection my_conn()
        {
            string Constr = "Data Source="+ Get_path() + ";Initial Catalog=IMS;Integrated Security=True;";
        ...
        public string GenerateQRCode(string studentId)
        {
            ...
            {
                throw new ArgumentException("Student ID Now Find For Sq Gen");
            }
            ...
            // Define the QR folder path
            string appPath = Application.StartupPath;
            string qrFolderPath = Path.Combine(appPath, "QR");
            ...
            string filePath = Path.Combine(qrFolderPath, $"Qr_{studentId}.png");
